...
public class OpenYouTubePlayerActivity extends Activity {
    ...
    private void setupView() {
        ...
        mVideoView.setId(3);
        android.widget.RelativeLayout.LayoutParams lVidViewLayoutParams = new android.widget.RelativeLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
    ...
    private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
        ...
        protected void onPostExecute(Uri pResult) {
           ...
           //     Uri uri=Uri.parse("http://viaviweb.in/kitkat/kitkat.flv");

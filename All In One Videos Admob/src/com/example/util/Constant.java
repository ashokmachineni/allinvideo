...
public class Constant implements Serializable{
	...
	public static final String SERVER_IMAGE_UPFOLDER="http://176.32.230.52/allvideo.com/youtube_vimeo_daily/images/thumbs/";
	...
	public static final String LATEST_URL = "http://176.32.230.52/allvideo.com/youtube_vimeo_daily/api.php?latest=15";
	//this url gives list of category in 2nd tab
	public static final String CATEGORY_URL = "http://176.32.230.52/allvideo.com/youtube_vimeo_daily/api.php";
	//this url gives item of specific category.
	public static final String CATEGORY_ITEM_URL = "http://176.32.230.52/allvideo.com/youtube_vimeo_daily/api.php?cat_id=";

	public static final String SERVER_IMAGE_UPFOLDER_OWN="http://176.32.230.52/allvideo.com/youtube_vimeo_daily/images/";
